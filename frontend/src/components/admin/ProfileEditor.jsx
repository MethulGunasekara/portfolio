    ...
    <div>
      ...
      <div className={styles.formGrid}>
        ...
        <div className={styles.field}>
          ...
          <div className={styles.uploadRow}>
            ...
            <label className={styles.uploadBtn}>
              {uploadingHero ? 'Uploading…' : <><i className="ri-upload-2-line" /> Upload Image</>}
        ...
        <div className={styles.field}>
          ...
          <div className={styles.uploadRow}>
            <label className={styles.uploadBtn}>
              {uploadingResume ? 'Uploading…' : <><i className="ri-file-pdf-line" /> Upload PDF</>}
      ...
      <button className={styles.saveBtn} onClick={save} disabled={loading}>
        {loading ? 'Saving…' : <><i className="ri-save-line" /> Save Profile</>}
      </button>
    </div>
  )
}